...
public class ApprovedFragment extends BaseFragment {
    ...
    public static ApprovedFragment startFragment() {
    ...
    private void requestVisitorData() {
        Connect.VisitorRecordsReq visitorRecordsReq = Connect.VisitorRecordsReq.newBuilder()
                ...
                .build();
        OkHttpUtil.getInstance().postEncrySelf(UriUtil.CONNECT_V3_PROXY_RECORDS_HISTORY, visitorRecordsReq, new ResultCall<Connect.HttpNotSignResponse>() {
            @Override
