...
public class SupportFeedbackActivity extends BaseActivity {
    ...
    private SupportFeedbackActivity mActivity;
    ...
    public void initView() {
        ...
        webView.loadUrl("https://feedback.connect.im/mobile/feedback/" + SharedPreferenceUtil.getInstance().getUser().getUid() + "?locale=" + languageCode);
    ...
    /**
     * Web page to the local library(4.0+)
     *
     * @param uploadMsg
     */
    ...
    /**
     * Web page to the local library(5.0+)
     *
     * @param uploadMsg
     */
