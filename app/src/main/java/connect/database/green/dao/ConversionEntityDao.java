...
public class ConversionEntityDao extends AbstractDao<ConversionEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Draft = new Property(6, String.class, "draft", false, "DRAFT");
        public final static Property Content = new Property(7, String.class, "content", false, "CONTENT");
        public final static Property Unread_count = new Property(8, Integer.class, "unread_count", false, "UNREAD_COUNT");
        public final static Property Unread_at = new Property(9, Integer.class, "unread_at", false, "UNREAD_AT");
        public final static Property Unread_attention = new Property(10, Integer.class, "unread_attention", false, "UNREAD_ATTENTION");
        public final static Property Top = new Property(11, Integer.class, "top", false, "TOP");
        public final static Property Last_time = new Property(12, Long.class, "last_time", false, "LAST_TIME");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONVERSION_ENTITY\" (" + //
                ...
                "\"UNREAD_COUNT\" INTEGER," + // 8: unread_count
                "\"UNREAD_AT\" INTEGER," + // 9: unread_at
                "\"UNREAD_ATTENTION\" INTEGER," + // 10: unread_attention
                "\"TOP\" INTEGER," + // 11: top
                "\"LAST_TIME\" INTEGER);"); // 12: last_time
    }
    ...
    public ConversionEntity readEntity(Cursor cursor, int offset) {
        ConversionEntity entity = new ConversionEntity( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // draft
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // content
            cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8), // unread_count
            cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9), // unread_at
            cursor.isNull(offset + 10) ? null : cursor.getInt(offset + 10), // unread_attention
            cursor.isNull(offset + 11) ? null : cursor.getInt(offset + 11), // top
            cursor.isNull(offset + 12) ? null : cursor.getLong(offset + 12) // last_time
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ConversionEntity entity, int offset) {
        ...
        entity.setDraft(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setContent(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setUnread_count(cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8));
        entity.setUnread_at(cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9));
        entity.setUnread_attention(cursor.isNull(offset + 10) ? null : cursor.getInt(offset + 10));
        entity.setTop(cursor.isNull(offset + 11) ? null : cursor.getInt(offset + 11));
        entity.setLast_time(cursor.isNull(offset + 12) ? null : cursor.getLong(offset + 12));
     }
